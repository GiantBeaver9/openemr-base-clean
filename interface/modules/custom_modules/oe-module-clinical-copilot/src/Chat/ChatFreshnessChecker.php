...
final class ChatFreshnessChecker
{
    ...
    // Lockstep with SynthesisReadPath::PROMPT_VERSION (reduce-v5 for the
    // per-item analyte/drug-labeled reading guide) -- this digest MUST match the
    // one SynthesisReadPath computed for the cached doc.
